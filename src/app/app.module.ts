...
import { CommentsComponent } from './components/topics/comments/comments.component';
import { CommentsFormComponent } from './components/topics/comments-form/comments-form.component';
...
@NgModule({
  declarations: [
    ...
    AttributeComponent, FormsComponent, UsersComponent, UserFormComponent, TopicsComponent, TopicViewComponent, CommentsComponent, CommentsFormComponent
  ...
  providers: [UsersService, TopicsService, ForumService, {provide:LoginServiceImpl,  useClass: LoginServiceImpl}, DynamicService],
